...
{  	
    ...
    {
        g_au8SlvRxData[g_u8SlvDataLen] = (unsigned char)(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CDAT);
		...
		else if(u32Status == 0xB8)                   
    {
        ...
        ((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CDAT = g_u8SlvDataLen;
				g_u8SlvDataLen++;
