...
int32_t main(void)
{
    ...
    for(i = 0; i < 0x100; i++)
    {
		...
		strcpy(i2cWriteData[0], "aaaaaaa\0");
		strcpy(i2cWriteData[1], "bbbbb\0");
		strcpy(i2cWriteData[2], "ccccccccc\0");
		strcpy(i2cWriteData[3], "ddddddddddd\0");
		strcpy(i2cWriteData[4], "eeee\0");
		strcpy(i2cWriteData[5], "ff\0");
		
		i2cWriteDataEndPos = 6;
    ...
    printf("I2C Slave Mode is Running.\n");
		...
		while(1){
			if(i2cReadDataStartPos != i2cReadDataEndPos){
				...
				printf("%s \n", i2cReadData[i2cReadDataStartPos]);
				i2cReadDataStartPos++;
    ...
    while(1){
			continue;
			printf("%d - ", g_u8SlvDataLen);
			
			for(i = 0; i < 25; i++)
			{
					printf("%d ", g_au8SlvRxData[i]);
			}
			printf("\n");
		}
}
