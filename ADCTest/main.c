        ...
        if(u8Option == '1')
        {
            ...
            for(u32ChannelCount = 0; u32ChannelCount < 4; u32ChannelCount++)
            {
                ...
                //printf("Conversion result of channel %d: 0x%X (%d)\n", u32ChannelCount, i32ConversionData, i32ConversionData);
								...
								//conversedData = log((double)(3680 - i32ConversionData)) / log(1.06678657553);//log(1.06674768);
								//conversedData = log((double)(4000 - i32ConversionData)) / log(1.0674872022);
								//conversedData = log((double)(3800 - i32ConversionData)) / log(1.06705614803);
								//conversedData = log((double)(3700 - i32ConversionData)) / log(1.0668321045);
								//conversedData = log((double)(3690 - i32ConversionData)) / log(1.04370619755);
								//conversedData = log((double)(3700 - i32ConversionData)) / log(1.04372090935);
								//conversedData = log((double)(3800 - i32ConversionData)) / log(1.04386588925);
								//conversedData = log((double)(3750 - i32ConversionData)) / log(1.04379388006);
