...
void SYS_Init(void)
{
    ...
    ((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0040))->OFFD = 0xF << 16;

     
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->P1_MFP &= ~(0x00000101UL | 0x00000202UL | 0x00000404UL | 0x00000808UL);
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->P1_MFP |= 0x00000001UL | 0x00000002UL | 0x00000004UL | 0x00000008UL ;
...
static __inline uint32_t ADC_GetConversionRate()
{
    ...
    u32AdcClkSrcSel = ((((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL1 & (3ul << 2)) >> 2);
     
    return ((u32ClkTbl[u32AdcClkSrcSel]) / (((((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKDIV & (0xFFul << 16)) >> 16) + 1) / 21);
}
...
void AdcContScanModeTest()
{
    ...
    while(1)
    {
        ...
        if(u8Option == '1')
        {
            ...
            ((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000))->ADCHER |= ((((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000))->ADCHER & ~(0xFFul << 0)) | (0xF));
        ...
        else if(u8Option == '2')
        {
            ...
            ((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000))->ADCR = ((3UL<<2) | (1UL<<10) | (1UL<<0));
            ...
            {
                i32ConversionData = (((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000))->ADDR[(u32ChannelCount * 2)] & (0xFFFFul << 0)) >> 0;
...
int main(void)
{
    ...
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->REGWRPROT = 0x0;
