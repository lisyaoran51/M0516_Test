...
void PowerDownFunction(void)
{
    ...
    ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->SCR = 4;

     
    ((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->PWRCON = (((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->PWRCON & ~((1ul << 7) | (1ul << 8))) |
                  (1ul << 8) | (1ul << 5);
...
void TMR0_IRQHandler(void)
{
    ...
    if(TIMER_GetWakeupFlag(((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000))) == 1)
    {
        ...
        TIMER_ClearWakeupFlag(((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000)));
...
void SYS_Init(void)
{
    ...
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->P3_MFP &= ~0x00001010UL;
    ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->P3_MFP |= 0x00000010UL;
}
    ...
    while(g_au32TMRINTCount[0] < 10)
    {
        if(g_au32TMRINTCount[0] != u32InitCount)
        {
            ...
            if(g_au32TMRINTCount[0] == 1000)
            {
                ...
                while(1)
                {
                    if(((((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->PWRCON & (1ul << 6)) == (1ul << 6)) && (g_u8IsTMR0WakeupFlag == 1))
                        break;
                }
