...
void setPwm(){
    ...
    ((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0080))->PMD = (((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0080))->PMD & (~(0x3ul << 14))) | (0x1UL << 14);
		...
		((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CMR0 = 0x100;
		((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CMR1 = 0x200;
		((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CMR2 = 0x400;
		((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CMR3 = 0x800;
		
		((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CMR0 = 0x100;
		((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CMR1 = 0x200;
		((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CMR2 = 0x400;
		((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CMR3 = 0x800;
...
int32_t main(void)
{
    ...
    printf(" 7: Si (988Hz)\n");
		...
		u32Src = (((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL2 & ((3ul << 4) << (0x0 & 2))) >> (4 + (0x0 & 2));
    ...
    printf("clock source %d\n", u32Src);
		...
		printf("CNR: %d %d %d %d \n", ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CNR0, ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CNR1, ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CNR2, ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CNR3);

		
		printf("swePwm done\n");
		while(1){
			
			((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CMR0++;
			((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CMR1++;
			((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CMR2++;
			((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CMR3++;
			
			((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CMR0++;
			((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CMR1++;
			((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CMR2++;
			((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CMR3++;
			if(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CMR0 == 0x1000) ((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CMR0 = 0x0;
			if(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CMR1 == 0x1000) ((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CMR1 = 0x0;
			if(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CMR2 == 0x1000) ((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CMR2 = 0x0;
			if(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CMR3 == 0x1000) ((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CMR3 = 0x0;
			if(((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CMR0 == 0x1000) ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CMR0 = 0x0;
			if(((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CMR1 == 0x1000) ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CMR1 = 0x0;
			if(((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CMR2 == 0x1000) ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CMR2 = 0x0;
			if(((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CMR3 == 0x1000) ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CMR3 = 0x0;
