...
#line 14 "..\\I2cInterface.c"

#line 1 "..\\I2cInterface.h"
...
#line 10 "..\\I2cInterface.h"
#line 11 "..\\I2cInterface.h"

#line 1 "..\\CircularLinkedList.h"
...
#line 17 "..\\I2cInterface.c"

uint8_t g_au8SlvSendData[16];
uint8_t g_au8SlvReceiveData[16];

volatile struct CircularLinkedList* inputBuffer;
volatile struct CircularLinkedList* outputBuffer;
volatile short isOutputEmpty;	 
...
void I2C_SlaveTRx(uint32_t u32Status)
{
    ...
    {
        g_au8SlvReceiveData[g_u8SlvReceiveDataLen] = (unsigned char) ((((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)))->I2CDAT);
        ...
        if((unsigned char) ((((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)))->I2CDAT) == '\0')	 
        {
						...
						memset(g_au8SlvReceiveData, 0, sizeof(uint8_t) * 16);
        }
				if(g_u8SlvReceiveDataLen == 16){
    ...
    else if(u32Status == 0xB8)                   
    {
        ...
        ((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CDAT = g_au8SlvSendData[g_u8SlvSendDataLen];
				
        g_u8SlvSendDataLen++;
				
				if(g_u8SlvSendDataLen == 16){
 ...
 
    {
				g_u8SlvSendDataLen = 0;
				if(isOutputEmpty == -1){
					memset(g_au8SlvSendData, 0, sizeof(uint8_t) * 16);
...
void I2C0_Init(void)
{
    ...
    I2C_SetSlaveAddrMask(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)), 0, 0x01);
    I2C_SetSlaveAddrMask(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)), 1, 0x04);
    I2C_SetSlaveAddrMask(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)), 2, 0x01);
    I2C_SetSlaveAddrMask(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)), 3, 0x04);
...
void I2C0_Close(void)
{
    ...
    CLK_DisableModuleClock(((1UL<<30) |(0x0<<25) |(0x0<<10) |8));
